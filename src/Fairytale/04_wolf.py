...
class Fairytale():    
    ...
    def Wolf(self):
        ...
        f = open('/home/pi/Pibo_Conversation/src/Fairytale/data/04_wolf_story.txt', 'r')
        lines = f.readlines()
        # print(lines)
        ...
        pibo = cm.tts(bhv="do_question_S", string=f"는 여우나 늑대를 본 적이 있다면 말해 줄래?")
