...
class RunSchedule():
    ...
    def day(self):
        ...
        file = open(f"{UDfolder}/aa.csv", 'r', newline='', encoding='utf-8')
        ...
        if self.completion < 8:
            ...
            fix = {0:'Pibo_Conversation/src/Fairytale/19_shepherd.py', 1:'Pibo_Conversation/src/Roleplay/02_strong.py',
                   2:'Pibo_Conversation/src/Solution/01_badword.py', 3:'Pibo_Play/src/Soc/soc_2.py',
        ...
        try:
            ...
            with open('/home/pi/errlog/pibo_errmsg', 'w') as f:
