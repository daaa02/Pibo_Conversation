...
def o_explain():
    ...
    o.show(); time.sleep(1)
    o.draw_image("/home/pi/AI_pibo2/src/data/icon/화면_현재단계2.png")
    o.show(); time.sleep(1)
    o.draw_image("/home/pi/AI_pibo2/src/data/icon/화면_현재단계3.png")
    o.show(); time.sleep(1)
...
def o_concil():
    o.draw_image("/home/pi/AI_pibo2/src/data/icon/화면_default2.png")
    o.show()
